...
def init_db():
    with sqlite3.connect('games.db') as conn:
        ...
        c.execute('''CREATE TABLE IF NOT EXISTS games (
            ...
            usernames TEXT,  -- JSON list of usernames
            board TEXT,
            current_turn TEXT,
            status TEXT,
...
class ChainReactionGame:
    def __init__(self, room_id, host_id, host_username, board=None):
        ...
        self.players = [host_id]  # List of player IDs
        self.usernames = [host_username]  # List of usernames
        ...
        self.max_players = 4  # Support up to 4 players
    ...
    def make_move(self, player_id, row, col):
        ...
        # Determine player number (1 for player 1, 2 for player 2, etc.)
        ...
        # Check if only one player has cells left
